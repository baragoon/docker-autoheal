...
listenToDockerEvents()
{
  ...
  # Subscribe to docker events BEFORE stopping the container to avoid a race
  # where autoheal could restart the container before the event stream is attached.
